...
with tab1:
    ...
    # Collection items
        ...
        df['Journal'] = df['Journal'].replace(['The International Journal of Intelligence and Counter Intelligence', 'International Journal of Intelligence and Counter-Intelligence', 'International Journal of Intelligence and Counterintelligence', 'International Journal of Intelligence and CounterIntelligence'], 'Intl Journal of Intelligence and Counterintelligence')
